...
//Hvis det aktive Id IKKE er lig med 5, så skal den pluse sig selv med én
//Hvis det aktive Id ER lig med 5, så skal den skifte tilbage til 0
function nextImage(){
    if(activeId !== 5){
        activeId = activeId + 1;
    } else {
...
// Hvis det aktive Id ER lig med 0, så skal den skifte tilbage til 5
